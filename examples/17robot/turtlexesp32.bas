...
10010 PINM SP,1: PINM TP,1: PINM EP,0
10020 DEF FNP(A)=50+A*200/180
10030 DWRITE SP,0
10040 FOR I=1 TO 40: DELAY 20: PULSE SP,FNP(0): NEXT
10050 J=1
10060 FOR A=0 TO 180 STEP 45
10070 FOR I=1 TO 10: DELAY 20: PULSE SP,FNP(A): NEXT
10080 DWRITE EP,0
10090 PULSE TP,10
10100 E(J)=PULSE(EP,1,70)/29*100/2
10110 J=J+1
10120 NEXT
10130 FOR I=1 TO 40: DELAY 20: PULSE SP,FNP(90): NEXT
10190 RETURN
