...
15 REM 
20 REM "This code is written pure MS BASIC dialects. "
25 REM "Ported from IoT BASIC"
30 REM ""
...
11060 REM "a number - uses a IoT BASIC special feature @V, the number of chars"
11070 REM IF FNNU(C) THEN T$=MID$(A$, I): X=VAL(T$): I=I+@V: T=-127: GOTO 11400
...
13780 RETURN
13800 REM "The number parser, only needed if IoT BASIC is not used"
13810 REM "Currently only implemented for integers"
13820 REM T$=MID$(A$, I): X=VAL(T$): I=I+@V
13830 FOR K=I TO LEN(A$): T$=MID$(A$, K, 1)
13840 IF NOT (FNNU(ASC(T$)) OR T$="-") THEN 13860
13850 NEXT
13860 T$=MID$(A$, I, K-I+1): X=VAL(T$): I=K
13870 RETURN
