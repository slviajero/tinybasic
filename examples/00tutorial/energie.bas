...
3050 PRINT "Vergütung für Gesamtleistung:",V
3060 PRINT
3100 PRINT "*** Kosten der Anlage und Strompreis ***"
3110 PRINT "****** Simulation ohne Inflation *******"
3120 GK=PA*(1+WK/100)
3125 PRINT "Wartungskosten:";TAB(32);#-8;GK-PA
3130 PRINT "Gesamtkosten inkl Wartung:";TAB(32);#-8;GK
3160 PRINT "Kosten Stromversorger pro Jahr:";TAB(32);#-8;PS/100*VE
3170 PRINT "Kosten Stromversorger Laufzeit:";TAB(32);#-8;PS/100*VE*LZ
3200 PRINT "*** Einspeisevergütung ***"
3210 PRINT "Einspeisung pro Jahr:";TAB(32);#-8;EA-VE 
3220 VJ=INT((EA-VE)*V/100)
3230 PRINT "Vergütung pro Jahr:";TAB(32);#-8;VJ
3240 VG=VJ*LZ
3250 PRINT "Vergütung über Laufzeit: ";TAB(32);#-8;VG
3260 PRINT "Eingesparte Stromkosten: ";TAB(32);#-8;PS/100*VE*LZ
3270 PRINT "Erträge und Einsparungen:";TAB(32);#-8;VG+PS/100*VE*LZ
...
3550 PRINT "Vergütung über Laufzeit: ";TAB(32);#-8; VG
3560 PRINT "Eingesparte Stromkosten: ";TAB(32);#-8; GI 
3570 PRINT "Erträge und Einsparungen:";TAB(32);#-8; VG+GI
