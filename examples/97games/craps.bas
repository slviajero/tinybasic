1 PRINT "Craps from 101 BASIC games"
5 PRINT "Originally from DEC, ported to Stefan's BASIC in 2021"
10 @R=MILLIS(1)
12 PRINT
15 LET R=0
18 PRINT"2,3,12 ARE LOSERS; 4,5,6,8,9,10 ARE POINTS;"
19 PRINT"7,11 ARE NATURAL WINNERS."
20 PRINT
21 LET T=1
