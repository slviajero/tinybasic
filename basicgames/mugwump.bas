1 PRINT "MUGWUMP from 101 BASIC games"
...
300 INPUT M,N
310 FOR I=1 TO 4
320 IF P(I)=-1 THEN 400
330 IF P(I)<>M THEN 380
340 IF P(I+4)<>N THEN 380
350 P(I)=-1
360 PRINT "YOU HAVE FOUND MUGWUMP";I
370 GOTO 400
380 D=SQR(POW(P(I)-M, 2)+POW(P(I+4)-N,2))
390 PRINT "YOU ARE",(INT(D*10))/10,"UNITS FROM MUGWUMP",I
400 NEXT I
410 FOR J=1 TO 4
420 IF P(J)<>-1 THEN 470
430 NEXT J
440 PRINT
...
540 FOR I=1 TO 4
550 IF P(I)=-1 THEN 570
560 PRINT "MUGWUMP",I,"IS AT (",P(I),",",P(I+4),")"
570 NEXT I
580 PRINT
