 ...
 *      but NOT is C not. 
 *  HASLONGNAMES: use long names for variables and functions. This is an untested
 *      feature and may not work as expected. It is not recommended to use it right now.
 */
